...
class GMSPlacesClientWrapperMock: GMSPlacesClientWrapper {
    ...
    override func findAutocompletePredictions(fromQuery: String, filter: GMSAutocompleteFilter, sessionToken: GMSAutocompleteSessionToken?, callback: @escaping GMSAutocompletePredictionCallbackWrapper) {
