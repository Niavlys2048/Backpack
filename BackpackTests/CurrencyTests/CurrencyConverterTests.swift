...
final class CurrencyConverterTests: XCTestCase {
    ...
    func test_convertCurrency_EmptyAmount_Success() {
        ...
        let originalAmounts = currencyData.map(\.amount).sorted()
        let resultAmounts = result.map(\.amount).sorted()
    ...
    func test_convertCurrency_AmountWithoutSeparator_Success() {
        ...
        let resultAmounts = result.map(\.amount)
    ...
    func test_convertCurrency_LargeAmountWithSeparator_Success() {
        ...
        let expectedJPYAmount = 7_041_331.19.displayCurrency
