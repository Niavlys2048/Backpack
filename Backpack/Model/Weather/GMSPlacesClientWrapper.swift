...
class GMSPlacesClientWrapper {
    ...
    func findAutocompletePredictions(fromQuery: String, filter: GMSAutocompleteFilter, sessionToken: GMSAutocompleteSessionToken?, callback: @escaping GMSAutocompletePredictionCallbackWrapper) {
